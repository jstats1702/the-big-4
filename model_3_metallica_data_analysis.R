...
load("samples_model_3_metallica.RData")
...
x11()
plot_lambda_by_layer(samples$lambda)
...
x11()
plot_geometry_strength_by_layer(samples$U, samples$lambda)
...
dic_model_3(log_lik, samples, y, X)

waic_model_3(samples, y, X)

# Test statistics ==============================================================

x11()
plot_test_stats_model_3(samples, y, X, layer_titles = c(1,2,3,4))
