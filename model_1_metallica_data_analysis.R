...
load("samples_model_1_metallica.RData")
...
names(MCE) <- c("zeta", "mu", "delta", "vartheta",  
                "omega2", "sigma2", "tau2", "kappa2")
...
rownames(tab) <- c("omega", "sigma", "tau", "kappa")
...
dic_model_1(log_lik, samples, y)

waic_model_1(samples, y)

# Test statistics ==============================================================

x11()
plot_test_stats_model_1(samples, y, layer_titles = c(1,2,3,4))
