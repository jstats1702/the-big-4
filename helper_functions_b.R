...
prob_metrics_per_layer_model_1 <- function(samples,
     ...
     for (ii in seq_along(s_index)) {
          ...
          P_s <- interaction_prob_cpp(delta_s, zeta_s, K)
...
prob_metrics_per_layer_model_3 <- function(samples, 
     ...
     for (ii in seq_along(s_index)) {
          ...
          P_s <- interaction_prob_cpp(mu_s, delta_s, U_s, lambda_s, zeta_s)
...
prob_metrics_per_layer_model_5 <- function(samples, 
     ...
     for (ii in seq_along(s_index)) {
          ...
          # Predicted probabilities
          P_s <- interaction_prob_cpp(mu_s, delta_s, Theta_s, xi_s, zeta_s)
...
dic_model_1 <- function(log_lik, 
     ...
     log_lik_hat <- log_likelihood_iter_cpp(y, delta_hat, zeta_hat, eps)
...
dic_model_3 <- function(log_lik,
     ...
     log_lik_hat <- log_likelihood_iter_cpp(
          y, mu_hat, delta_hat, S_hat, lambda_hat, zeta_hat, eps
     )
     Dhat <- -2 * log_lik_hat
...
waic_model_1 <- function(samples, 
     ...
     for (ii in seq_along(s_index)) {
          ...
          ll_mat[ii, ] <- log_likelihood_pointwise_cpp(y, delta_s, zeta_s, eps)
     }
...
waic_model_3 <- function(samples,
     ...
     for (ii in seq_along(s_index)) {
          ...
          ll_mat[ii, ] <- log_likelihood_pointwise_cpp(
               y, mu_s, delta_s, U_s, lambda_s, zeta_s, eps
          )
     }
...
waic_model_5 <- function(samples,
     ...
     for (ii in seq_along(s_index)) {
          ...
          ll_mat[ii, ] <- log_likelihood_pointwise_cpp(
               y, mu_s, delta_s, Theta_s, xi_s, zeta_s, eps
          )
     }
...
plot_test_stats_model_1 <- function(samples, 
     ...
     for (ii in seq_along(s_index)) {
          ...
          y_sim <- simulate_multilayer_network_cpp(delta_s, zeta_s, K)
...
plot_test_stats_model_3 <- function(samples, 
     ...
     for (ii in seq_along(s_index)) {
          ...
          y_sim <- simulate_multilayer_network_cpp(mu_s, delta_s, U_s, lambda_s, zeta_s)
...
plot_test_stats_model_5 <- function(samples, 
     ...
     for (ii in seq_along(s_index)) {
          ...
          # Model 5 simulator
          y_sim <- simulate_multilayer_network_cpp(mu_s, delta_s, Theta_s, xi_s, zeta_s)
