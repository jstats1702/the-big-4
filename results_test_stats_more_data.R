...
compute_ppc_stats <- function(dataset, model) {
     ...
     cpp_file <- paste0(model, "_mcmc_algorithm_b.cpp")
     ...
     if (model == "model_1") {
          # No covariates
          test <- plot_fun(samples, y, K, layer_titles = layer_titles)
...
compute_ppc_all_models("wiring")
compute_ppc_all_models("tech")
compute_ppc_all_models("seven")
compute_ppc_all_models("girls")
compute_ppc_all_models("aarhus")
compute_ppc_all_models("micro")
